...
public class MeetingBoard {
	...
	public String toString() {
		return "MeetingBoard [nickname=" + nickname + ", meeting_board_no=" + meeting_board_no
				+ ", meeting_board_writer=" + meeting_board_writer + ", meeting_no=" + meeting_no
				+ ", meeting_board_title=" + meeting_board_title + ", meeting_board_content=" + meeting_board_content
				+ ", meeting_board_date=" + meeting_board_date + ", meeting_board_hit=" + meeting_board_hit + "]";
	}
